 ...
 * The 'multilingual' preset is explicitly over budget (118 MB) — it is the
 * opt-in escape hatch documented in README §Multilingual.
 */
export const EMBEDDING_PRESETS = {
  ...
  multilingual: { model: 'Xenova/multilingual-e5-small',      sizeMb: 118, lang: 'multilingual', symmetric: false },
} as const;
